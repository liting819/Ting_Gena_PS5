...
```{python}
df_2021 = scrape_enforcement_actions(1, 2023)
```
...
There are 1534 enforcement actions in the  dataframe

```{python}
df_2021.sort_values(by = "Date",ascending = False)
```

The earliest is September 8, 2023.
The title is "Elite Medical Transport Agreed to Pay $153,000", the category is Fraud Self-Disclosures, and no agency to be found. 
